...
## Switches
#set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { din[0] }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
#set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { din[1] }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
#set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { din[2] }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
#set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { din[3] }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]

# RGB LEDs
#set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { hw_light[2] }]; #IO_L18N_T2_35 Sch=led0_b
#set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { hw_light[1] }]; #IO_L19N_T3_VREF_35 Sch=led0_g
#set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { hw_light[0] }]; #IO_L19P_T3_35 Sch=led0_r
##set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { led[10] }]; #IO_L20P_T3_35 Sch=led1_b
##set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { led[11] }]; #IO_L21P_T3_DQS_35 Sch=led1_g
##set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { led[5] }]; #IO_L20N_T3_35 Sch=led1_r
##set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { led[12] }]; #IO_L21N_T3_DQS_35 Sch=led2_b
##set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { led[13] }]; #IO_L22N_T3_35 Sch=led2_g
##set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { led[6] }]; #IO_L22P_T3_35 Sch=led2_r
#set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { l_light[2] }]; #IO_L23P_T3_35 Sch=led3_b
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { l_light[1] }]; #IO_L24P_T3_35 Sch=led3_g
#set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { l_light[0] }]; #IO_L23N_T3_35 Sch=led3_r

#### LEDs
#set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports {}]; #IO_L24N_T3_35 Sch=led[4]
#set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports {}]; #IO_25_35 Sch=led[5]
#set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports {}]; #IO_L24P_T3_A01_D17_14 Sch=led[6]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports {}]; #IO_L24N_T3_A00_D16_14 Sch=led[7]

## Buttons
#set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { pb_wr }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
## Pmod Header JC
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports sd]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports bclk]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports lrclk]
...
set_property PACKAGE_PIN V9 [get_ports {sample[7]}]
set_property PACKAGE_PIN M6 [get_ports {sample[14]}]
set_property PACKAGE_PIN R7 [get_ports {sample[4]}]
set_property PACKAGE_PIN R8 [get_ports {sample[2]}]
set_property PACKAGE_PIN R6 [get_ports {sample[12]}]
set_property PACKAGE_PIN U9 [get_ports {sample[8]}]
set_property PACKAGE_PIN T1 [get_ports {sample[15]}]
set_property PACKAGE_PIN T8 [get_ports {sample[1]}]
set_property PACKAGE_PIN R1 [get_ports sample_valid]
set_property PACKAGE_PIN R5 [get_ports {sample[11]}]
set_property PACKAGE_PIN U8 [get_ports {sample[0]}]
set_property PACKAGE_PIN N6 [get_ports {sample[13]}]
set_property PACKAGE_PIN T6 [get_ports {sample[3]}]
set_property PACKAGE_PIN U6 [get_ports {sample[5]}]
set_property PACKAGE_PIN U7 [get_ports {sample[6]}]
set_property PACKAGE_PIN V7 [get_ports {sample[10]}]
set_property PACKAGE_PIN V6 [get_ports {sample[9]}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {debug_shift_reg[0]} {debug_shift_reg[1]} {debug_shift_reg[2]} {debug_shift_reg[3]} {debug_shift_reg[4]} {debug_shift_reg[5]} {debug_shift_reg[6]} {debug_shift_reg[7]} {debug_shift_reg[8]} {debug_shift_reg[9]} {debug_shift_reg[10]} {debug_shift_reg[11]} {debug_shift_reg[12]} {debug_shift_reg[13]} {debug_shift_reg[14]} {debug_shift_reg[15]} {debug_shift_reg[16]} {debug_shift_reg[17]} {debug_shift_reg[18]} {debug_shift_reg[19]} {debug_shift_reg[20]} {debug_shift_reg[21]} {debug_shift_reg[22]} {debug_shift_reg[23]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 6 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {debug_bit_count[0]} {debug_bit_count[1]} {debug_bit_count[2]} {debug_bit_count[3]} {debug_bit_count[4]} {debug_bit_count[5]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 16 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {debug_sample[0]} {debug_sample[1]} {debug_sample[2]} {debug_sample[3]} {debug_sample[4]} {debug_sample[5]} {debug_sample[6]} {debug_sample[7]} {debug_sample[8]} {debug_sample[9]} {debug_sample[10]} {debug_sample[11]} {debug_sample[12]} {debug_sample[13]} {debug_sample[14]} {debug_sample[15]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list debug_bclk]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list debug_lrclk]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 1 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list debug_sample_valid]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe6]
set_property port_width 1 [get_debug_ports u_ila_0/probe6]
connect_debug_port u_ila_0/probe6 [get_nets [list debug_sd]]
